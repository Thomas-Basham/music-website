...
export default function lonelyMeNewsPost() {
  ...
  return (
    <div className="flex-col p-6 text-white opacity-90 d-flex">
      ...
      <SongStreamingLinks deezer="https://www.deezer.com/us/album/290466652" amazon="https://music.amazon.com/albums/B09R2MMGDW" apple="https://music.apple.com/us/album/fumes-single/1606804360?uo=4" pandora="https://www.pandora.com/artist/tommy-basham/fumes-single/ALtz2J4PfnK9mf9" spotify="https://open.spotify.com/album/6uB0L73lIBOcVb55tmvkmK"  />
      <div className="mt-2">
        {SpotifyPlayer(
      ...
      <p className="p-12 mt-6 border-2 border-white">
        ...
        <br></br>
        <br></br>
        The song quickly picks up as the beat drops with
        heavy grinding bass and a fluttering melody. It all ends with an
        extremely vibey solo to lift your mood even higher. 
        <br></br>
        <br></br>
