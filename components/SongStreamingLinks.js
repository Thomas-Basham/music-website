...
export default function SongStreamingLinks() {
  return (
    ...
    <a
      href="https://open.spotify.com/album/4fTxg8tjCU1NUDYEywQLV1"
    ...
    <a
      href="https://music.apple.com/us/album/lonely-me-single/1603526055?uo=4"
      className="text-white text-decoration-none"
    ...
    <a
      href="https://music.amazon.com/albums/B09PTBL81N?tag=fndcmpgns-20"
      className="text-white text-decoration-none"
    ...
    <a
      href="https://www.deezer.com/us/album/285645392"
      className="text-white text-decoration-none"
