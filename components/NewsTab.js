...
export default function NewsTab(props) {
  let spotifyUrl = `https://open.spotify.com/track/${props.spotifyTrackID}?si=db7b62083e8c4253`;
  return (
      ...
      >
        <div className="justify-between clear-both cursor-pointer d-flex article-content">
          ...
          <div className="container player-holder">
            <SpotifyPlayer
              url={`https://open.spotify.com/embed/track/${props.spotifyTrackID}?utm_source=generator&theme=0`}
              size="small"
            />
          </div>
        </div>
